...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
		...
		PS1='\[\e]0;\u@\h: \w\a\]\[\033[01;32m\]:\u@\h\[\033[00m\]\[\033[01;35m\]$(parse_git_branch)\[\033[00m\] \[\033[01;34m\]\W>\[\033[00m\] '
	fi
...
# Project definitions.
# You may want to put all your additions related to projects
# into a separate file like ~/.bash_for_projects, instead of adding them here directly.
# See /usr/share/doc/bash-doc/examples in the bash-doc package.

if [ -f ~/.bash_for_projects ]; then
    . ~/.bash_for_projects
fi
