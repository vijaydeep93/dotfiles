...
alias kgpos='kubectl get pod --field-selector=status.phase==Succeeded'
alias kgposn='kubectl get pod --field-selector=status.phase==Succeeded --namespace'
alias krmpos='kubectl delete pod --field-selector=status.phase==Succeeded'
alias krmposn='kubectl delete pod --field-selector=status.phase==Succeeded --namespace'
alias kgpoe='kubectl get pod --field-selector=status.phase==Failed'
alias kgpoen='kubectl get pod --field-selector=status.phase==Failed --namespace'
alias krmpoe='kubectl delete pod --field-selector=status.phase==Failed'
alias krmpoen='kubectl delete pod --field-selector=status.phase==Failed --namespace'

alias kcc="kubectl run -i --tty ubuntu --rm --image=ubuntu:latest --restart=Never -- bash -il" # ubuntu client to run in cluster
